...
peso = float(input('Informe o peso(kg) dos peixes:'))
if peso > 50:
  excesso = peso - 50
  multa = excesso * 4
  print(f'A quantidade excedente da pesca foi: {excesso}')
  print(f'A multa pelo excedente da pesca foi: {multa}')
else:
  print('Pesca realizada dentro do regulamento.')